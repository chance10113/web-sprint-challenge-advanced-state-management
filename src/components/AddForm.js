...
import { fetchSmurfFailure, addSmurf, editError } from "../actions/index";
...
//4. Within the handleSubmit function, call your addSmurf action with the smurf name, position, nickname and summary
//   passed as arguments. Test that a smurf is correctly added to when the form is submitted.
